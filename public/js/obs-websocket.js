/*
 * obs-websocket-js v5 (minified bundle)
 * Usage: const obs = new OBSWebSocket(); await obs.connect('ws://host:4455', 'password');
 * Example: // Called by explorer Send to OBS action after this script is loaded.
 */
