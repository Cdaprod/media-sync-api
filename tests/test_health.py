...
def test_health_endpoint(client):
    ...
    assert payload.get("live_sessions_enabled") is True
    ...
    assert runtime_services.get("live_session_registry") is True
    assert runtime_services.get("live_session_service") is True
