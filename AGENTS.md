...
- Explorer drawer previews now use a richer inner renderer in both static and package UIs (media-first shell, overlay header/chips, playback fade behavior, waveform treatment for audio) while preserving right-side drawer layout and existing inspector/actions.
